...
class SimpleSignalDashboard {
    ...
    async handleSelectModel(message) {
        ...
        const action = await vscode.window.showInformationMessage(`✨ Selected "${message.modelId}" [${message.endpointName}] as active Chat Model!`, 'New Chat with Model', 'Open Chat');
