...
class SimpleSignalDashboard {
    ...
    static onModelSelectionChanged;
    ...
    async handleSelectModel(message) {
        ...
        const action = await vscode.window.showInformationMessage(`✨ Selected "${message.modelId}" [${message.endpointName}] as active Chat Model! (Copied ID to clipboard)`, 'Open Chat');
        if (action === 'Open Chat') {
